...
const SignUpPublish = () => {
  ...
  const handleSignUp = async (e) => {
    ...
    try {
      const response = await fetch("https://api.iwemiresearch.org/api/auth/register/", {
        method: 'POST',
        headers: {
                ...
                <div className="w-full bg-white rounded-lg shadow dark:border md:mt-0 sm:max-w-md xl:p-0 dark:bg-gray-800 dark:border-gray-700">
                  <div className="p-6 space-y-4 md:space-y-6 sm:p-8">
                    ...
                    <form className="space-y-4 md:space-y-6" onSubmit={handleSignUp}>
                      <div>
                        <label htmlFor="publisherName" className="block mb-2 text-sm font-medium text-gray-900 dark:text-white">Your Institution Name</label>
                      ...
                      <div className="flex items-start">
                        ...
                        <div className="ml-3 text-sm">
                          <label htmlFor="terms" className="font-light text-gray-500 dark:text-gray-300">I accept the <a href='/terms-Conditions' className="font-medium text-primary-600 hover:underline dark:text-primary-500">Terms and Conditions</a></label>
                        </div>
                      </div>
