...
*/}
            <dl class=" max-w-md text-gray-900 divide-y divide-gray-200 dark:text-white dark:divide-gray-700 ms-7 mt-7 mb-7">
                ...
                <div class="flex flex-col py-3">
                    <dt class="mb-1 text-gray-500 md:text-lg dark:text-gray-400">Headquarters</dt>
                    <dd class="text-lg font-semibold">United Kingdom: 71-75,
