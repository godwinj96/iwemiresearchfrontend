                                            ...
                                            <ul className='type-category' >
                                                        ...
                                                        (<div className='ms-3'>
                                                            <ul className="">
                                                                <li className="flex items-center mb-4">
                                                                    ...
                                                                    <label htmlhtmlFor="agriculture-checkbox" className="ms-2 text-sm font-medium text-gray-900 dark:text-gray-300">Agriculture</label>
                                                                </li>
                                                                <li className="flex items-center mb-4">
                                                                    ...
                                                                    <label htmlhtmlFor="agriculturalEconomics" className="ms-2 text-sm font-medium text-gray-900 dark:text-gray-300">Agricultural Economics</label>
                                                                </li>
                                                                <li className="flex items-center mb-4">
                                                                    ...
                                                                    <label htmlhtmlFor="agriculturalExtension" className="ms-2 text-sm font-medium text-gray-900 dark:text-gray-300">Agricultural Extension</label>
                                                                </li>
                                                                <li className="flex items-center mb-4">
                                                                    ...
                                                                    <label htmlhtmlFor="agronomy" className="ms-2 text-sm font-medium text-gray-900 dark:text-gray-300">Agronomy</label>
                                                                </li>
                                                                <li className="flex items-center mb-4">
                                                                    ...
                                                                    <label htmlhtmlFor="animalScience" className="ms-2 text-sm font-medium text-gray-900 dark:text-gray-300">Animal Science</label>
                                                                </li>
                                                                <li className="flex items-center mb-4">
                                                                    ...
                                                                    <label htmlhtmlFor="cropScience" className="ms-2 text-sm font-medium text-gray-900 dark:text-gray-300">Crop Science</label>
                                                                </li>
                                                                <li className="flex items-center mb-4">
                                                                    <input id="foodScience" type="checkbox" checked={checkboxValues.foodScience} onChange={handleCheckboxChange} className="w-4 h-4 text-blue-600 bg-gray-100 border-gray-300 rounded focus:ring-blue-500 dark:focus:ring-blue-600 dark:ring-offset-gray-800 focus:ring-2 dark:bg-gray-700 dark:border-gray-600" onClick={(e) => e.stopPropagation()} />
                                                                    <label htmlhtmlFor="foodScience" className="ms-2 text-sm font-medium text-gray-900 dark:text-gray-300">Food Science and Technology</label>
                                                                </li>
                                                                <li className="flex items-center mb-4">
                                                                    ...
                                                                    <label htmlhtmlFor="fisheries" className="ms-2 text-sm font-medium text-gray-900 dark:text-gray-300">Fisheries</label>
                                                                </li>
                                                                <li className="flex items-center mb-4">
                                                                    ...
                                                                    <label htmlhtmlFor="forestry" className="ms-2 text-sm font-medium text-gray-900 dark:text-gray-300">Forest Resources Management (Forestry)</label>
                                                                </li>
                                                                <li className="flex items-center mb-4">
                                                                    ...
                                                                    <label htmlhtmlFor="homeScience" className="ms-2 text-sm font-medium text-gray-900 dark:text-gray-300">Home Science, Nutrition and Dietetics</label>
                                                                </li>
                                                                <li className="flex items-center mb-4">
                                                                    ...
                                                                    <label htmlhtmlFor="soilScience" className="ms-2 text-sm font-medium text-gray-900 dark:text-gray-300">Soil Science</label>
                                                                </li>
                                                            </ul>
                                                        </div>)
                                                    }
                                                ...
                                                <li className="flex flex-col mb-4" onClick={() => eachCategoryDropDown('arts')}>
                                                    <div className="flex items-center hover:bg-gray-100 dark:hover:bg-gray-700">
                                                        ...
                                                        <label htmlhtmlFor="default-checkbox" className="ms-2 text-sm font-medium text-gray-900 dark:text-gray-300">Arts</label>
                                                        ...
                                                        <div className="ms-3">
                                                            <ul>
                                                                <li className="flex items-center mb-4">
                                                                    ...
                                                                    <label htmlhtmlFor="archeology" className="ms-2 text-sm font-medium text-gray-900 dark:text-gray-300">Archeology and Tourism</label>
                                                                </li>
                                                                <li className="flex items-center mb-4">
                                                                    ...
                                                                    <label htmlhtmlFor="arabicStudies" className="ms-2 text-sm font-medium text-gray-900 dark:text-gray-300">Arabic and Islamic Studies</label>
                                                                </li>
                                                                <li className="flex items-center mb-4">
                                                                    ...
                                                                    <label htmlhtmlFor="christianStudies" className="ms-2 text-sm font-medium text-gray-900 dark:text-gray-300">Christian Religious Studies</label>
                                                                </li>
                                                                <li className="flex items-center mb-4">
                                                                    ...
                                                                    <label htmlhtmlFor="englishStudies" className="ms-2 text-sm font-medium text-gray-900 dark:text-gray-300">English and Literary Studies</label>
                                                                </li>
                                                                <li className="flex items-center mb-4">
                                                                    ...
                                                                    <label htmlhtmlFor="fineArts" className="ms-2 text-sm font-medium text-gray-900 dark:text-gray-300">Fine and Applied Arts (Creative Arts)</label>
                                                                </li>
                                                                <li className="flex items-center mb-4">
                                                                    ...
                                                                    <label htmlhtmlFor="foreignLanguages" className="ms-2 text-sm font-medium text-gray-900 dark:text-gray-300">Foreign Languages and Literature</label>
                                                                </li>
                                                                <li className="flex items-center mb-4">
                                                                    ...
                                                                    <label htmlhtmlFor="history" className="ms-2 text-sm font-medium text-gray-900 dark:text-gray-300">History and International Studies</label>
                                                                </li>
                                                                <li className="flex items-center mb-4">
                                                                    ...
                                                                    <label htmlhtmlFor="linguistics" className="ms-2 text-sm font-medium text-gray-900 dark:text-gray-300">Linguistics and Nigerian Languages</label>
                                                                </li>
                                                                <li className="flex items-center mb-4">
                                                                    ...
                                                                    <label htmlhtmlFor="massCommunication" className="ms-2 text-sm font-medium text-gray-900 dark:text-gray-300">Mass Communication (Communication and Language Arts)</label>
                                                                </li>
                                                                <li className="flex items-center mb-4">
                                                                    ...
                                                                    <label htmlhtmlFor="music" className="ms-2 text-sm font-medium text-gray-900 dark:text-gray-300">Music</label>
                                                                </li>
                                                                <li className="flex items-center mb-4">
                                                                    <input id="theatreStudies" type="checkbox" checked={checkboxValues.theatreStudies} onChange={handleCheckboxChange} className="w-4 h-4 text-blue-600 bg-gray-100 border-gray-300 rounded focus:ring-blue-500 dark:focus:ring-blue-600 dark:ring-offset-gray-800 focus:ring-2 dark:bg-gray-700 dark:border-gray-600" onClick={(e) => e.stopPropagation()} />
                                                                    <label htmlhtmlFor="theatreStudies" className="ms-2 text-sm font-medium text-gray-900 dark:text-gray-300">Theatre and Film Studies</label>
                                                                </li>
                                                            </ul>
                                                        </div>
                                                    )}
                                                ...
                                                <li className="flex flex-col mb-4" onClick={() => eachCategoryDropDown('biologicalSciences')}>
                                                    <div className="flex items-center hover:bg-gray-100 dark:hover:bg-gray-700">
                                                        <input id="default-checkbox" type="checkbox" value="" className="w-4 h-4 text-blue-600 bg-gray-100 border-gray-300 rounded focus:ring-blue-500 dark:focus:ring-blue-600 dark:ring-offset-gray-800 focus:ring-2 dark:bg-gray-700 dark:border-gray-600" onClick={(e) => e.stopPropagation()} />
                                                        <label htmlhtmlFor="default-checkbox" className="ms-2 text-sm font-medium text-gray-900 dark:text-gray-300">Biological Sciences</label>
                                                        ...
                                                        <div className="ms-3">
                                                            <ul>
                                                                <li className="flex items-center mb-4">
                                                                    ...
                                                                    <label htmlhtmlFor="biochemistry" className="ms-2 text-sm font-medium text-gray-900 dark:text-gray-300">Biochemistry</label>
                                                                </li>
                                                                <li className="flex items-center mb-4">
                                                                    <input id="botany" type="checkbox" checked={checkboxValues.botany} onChange={handleCheckboxChange} className="w-4 h-4 text-blue-600 bg-gray-100 border-gray-300 rounded focus:ring-blue-500 dark:focus:ring-blue-600 dark:ring-offset-gray-800 focus:ring-2 dark:bg-gray-700 dark:border-gray-600" onClick={(e) => e.stopPropagation()} />
                                                                    <label htmlhtmlFor="botany" className="ms-2 text-sm font-medium text-gray-900 dark:text-gray-300">Botany</label>
                                                                </li>
                                                                <li className="flex items-center mb-4">
                                                                    <input id="microbiology" type="checkbox" checked={checkboxValues.microbiology} onChange={handleCheckboxChange} className="w-4 h-4 text-blue-600 bg-gray-100 border-gray-300 rounded focus:ring-blue-500 dark:focus:ring-blue-600 dark:ring-offset-gray-800 focus:ring-2 dark:bg-gray-700 dark:border-gray-600" onClick={(e) => e.stopPropagation()} />
                                                                    <label htmlhtmlFor="microbiology" className="ms-2 text-sm font-medium text-gray-900 dark:text-gray-300">Microbiology</label>
                                                                </li>
                                                                <li className="flex items-center mb-4">
                                                                    ...
                                                                    <label htmlhtmlFor="marineBiology" className="ms-2 text-sm font-medium text-gray-900 dark:text-gray-300">Marine Biology</label>
                                                                </li>
                                                                <li className="flex items-center mb-4">
                                                                    ...
                                                                    <label htmlhtmlFor="cellBiology" className="ms-2 text-sm font-medium text-gray-900 dark:text-gray-300">Cell Biology & Genetics</label>
                                                                </li>
                                                                <li className="flex items-center mb-4">
                                                                    ...
                                                                    <label htmlhtmlFor="zoology" className="ms-2 text-sm font-medium text-gray-900 dark:text-gray-300">Zoology</label>
                                                                </li>
                                                            </ul>
                                                        </div>
                                                    )}
                                                ...
                                                <li className="flex flex-col mb-4" onClick={() => eachCategoryDropDown('administration')}>
                                                    <div className="flex items-center hover:bg-gray-100 dark:hover:bg-gray-700">
                                                        ...
                                                        <label htmlhtmlFor="administration-checkbox" className="ms-2 text-sm font-medium text-gray-900 dark:text-gray-300">Administration</label>
                                                        ...
                                                        <div className="ms-3">
                                                            <ul>
                                                                <li className="flex items-center mb-4">
                                                                    ...
                                                                    <label htmlhtmlFor="accountancy" className="ms-2 text-sm font-medium text-gray-900 dark:text-gray-300">Accountancy</label>
                                                                </li>
                                                                <li className="flex items-center mb-4">
                                                                    ...
                                                                    <label htmlhtmlFor="actuarial-science" className="ms-2 text-sm font-medium text-gray-900 dark:text-gray-300">Actuarial Science</label>
                                                                </li>
                                                                <li className="flex items-center mb-4">
                                                                    <input id="business-administration" type="checkbox" checked={checkboxValues.businessAdministration} onChange={handleCheckboxChange} className="w-4 h-4 text-blue-600 bg-gray-100 border-gray-300 rounded focus:ring-blue-500 dark:focus:ring-blue-600 dark:ring-offset-gray-800 focus:ring-2 dark:bg-gray-700 dark:border-gray-600" onClick={(e) => e.stopPropagation()} />
                                                                    <label htmlhtmlFor="business-administration" className="ms-2 text-sm font-medium text-gray-900 dark:text-gray-300">Business Administration</label>
                                                                </li>
                                                                <li className="flex items-center mb-4">
                                                                    ...
                                                                    <label htmlhtmlFor="business-management" className="ms-2 text-sm font-medium text-gray-900 dark:text-gray-300">Business Management</label>
                                                                </li>
                                                                <li className="flex items-center mb-4">
                                                                    ...
                                                                    <label htmlhtmlFor="banking-finance" className="ms-2 text-sm font-medium text-gray-900 dark:text-gray-300">Banking and Finance</label>
                                                                </li>
                                                                <li className="flex items-center mb-4">
                                                                    <input id="hospitality-tourism" type="checkbox" checked={checkboxValues.hospitalityTourism} onChange={handleCheckboxChange} className="w-4 h-4 text-blue-600 bg-gray-100 border-gray-300 rounded focus:ring-blue-500 dark:focus:ring-blue-600 dark:ring-offset-gray-800 focus:ring-2 dark:bg-gray-700 dark:border-gray-600" onClick={(e) => e.stopPropagation()} />
                                                                    <label htmlhtmlFor="hospitality-tourism" className="ms-2 text-sm font-medium text-gray-900 dark:text-gray-300">Hospitality and Tourism</label>
                                                                </li>
                                                                <li className="flex items-center mb-4">
                                                                    ...
                                                                    <label htmlhtmlFor="marketing" className="ms-2 text-sm font-medium text-gray-900 dark:text-gray-300">Marketing</label>
                                                                </li>
                                                                <li className="flex items-center mb-4">
                                                                    <input id="insurance" type="checkbox" checked={checkboxValues.insurance} onChange={handleCheckboxChange} className="w-4 h-4 text-blue-600 bg-gray-100 border-gray-300 rounded focus:ring-blue-500 dark:focus:ring-blue-600 dark:ring-offset-gray-800 focus:ring-2 dark:bg-gray-700 dark:border-gray-600" onClick={(e) => e.stopPropagation()} />
                                                                    <label htmlhtmlFor="insurance" className="ms-2 text-sm font-medium text-gray-900 dark:text-gray-300">Insurance</label>
                                                                </li>
                                                                <li className="flex items-center mb-4">
                                                                    <input id="industrial-relations" type="checkbox" checked={checkboxValues.industrialRelations} onChange={handleCheckboxChange} className="w-4 h-4 text-blue-600 bg-gray-100 border-gray-300 rounded focus:ring-blue-500 dark:focus:ring-blue-600 dark:ring-offset-gray-800 focus:ring-2 dark:bg-gray-700 dark:border-gray-600" onClick={(e) => e.stopPropagation()} />
                                                                    <label htmlhtmlFor="industrial-relations" className="ms-2 text-sm font-medium text-gray-900 dark:text-gray-300">Industrial Relations and Personnel Management</label>
                                                                </li>
                                                            </ul>
                                                        </div>
                                                    )}
                                                ...
                                                <li className="flex flex-col mb-4" onClick={() => eachCategoryDropDown('dentistry')}>
                                                    <div className="flex items-center hover:bg-gray-100 dark:hover:bg-gray-700">
                                                        ...
                                                        <label htmlhtmlFor="dentistry-checkbox" className="ms-2 text-sm font-medium text-gray-900 dark:text-gray-300">Dentistry</label>
                                                        ...
                                                        <div className="ms-3">
                                                            <ul>
                                                                <li className="flex items-center mb-4">
                                                                    ...
                                                                    <label htmlhtmlFor="child-dental-health" className="ms-2 text-sm font-medium text-gray-900 dark:text-gray-300">Child Dental Health</label>
                                                                </li>
                                                                <li className="flex items-center mb-4">
                                                                    ...
                                                                    <label htmlhtmlFor="oral-maxillofacial-surgery" className="ms-2 text-sm font-medium text-gray-900 dark:text-gray-300">Oral and Maxillofacial Surgery</label>
                                                                </li>
                                                                <li className="flex items-center mb-4">
                                                                    <input id="preventive-dentistry" type="checkbox" checked={checkboxValues.preventiveDentistry} onChange={handleCheckboxChange} className="w-4 h-4 text-blue-600 bg-gray-100 border-gray-300 rounded focus:ring-blue-500 dark:focus:ring-blue-600 dark:ring-offset-gray-800 focus:ring-2 dark:bg-gray-700 dark:border-gray-600" onClick={(e) => e.stopPropagation()} />
                                                                    <label htmlhtmlFor="preventive-dentistry" className="ms-2 text-sm font-medium text-gray-900 dark:text-gray-300">Preventive Dentistry</label>
                                                                </li>
                                                                <li className="flex items-center mb-4">
                                                                    ...
                                                                    <label htmlhtmlFor="restorative-dentistry" className="ms-2 text-sm font-medium text-gray-900 dark:text-gray-300">Restorative Dentistry</label>
                                                                </li>
                                                            </ul>
                                                        </div>
                                                    )}
                                                ...
                                                <li className="flex flex-col mb-4" onClick={() => eachCategoryDropDown('education')}>
                                                    <div className="flex items-center hover:bg-gray-100 dark:hover:bg-gray-700">
                                                        ...
                                                        <label htmlhtmlFor="education-checkbox" className="ms-2 text-sm font-medium text-gray-900 dark:text-gray-300">Education</label>
                                                        ...
                                                        <div className="ms-3">
                                                            <ul>
                                                                <li className="flex items-center mb-4">
                                                                    ...
                                                                    <label htmlhtmlFor="adult-education" className="ms-2 text-sm font-medium text-gray-900 dark:text-gray-300">Adult Education and Extra-Mural Studies</label>
                                                                </li>
                                                                <li className="flex items-center mb-4">
                                                                    ...
                                                                    <label htmlhtmlFor="arts-education" className="ms-2 text-sm font-medium text-gray-900 dark:text-gray-300">Arts Education</label>
                                                                </li>
                                                                <li className="flex items-center mb-4">
                                                                    ...
                                                                    <label htmlhtmlFor="education-accountancy" className="ms-2 text-sm font-medium text-gray-900 dark:text-gray-300">Education &amp; Accountancy</label>
                                                                </li>
                                                                <li className="flex items-center mb-4">
                                                                    ...
                                                                    <label htmlhtmlFor="education-computer-science" className="ms-2 text-sm font-medium text-gray-900 dark:text-gray-300">Education &amp; Computer Science</label>
                                                                </li>
                                                                <li className="flex items-center mb-4">
                                                                    ...
                                                                    <label htmlhtmlFor="education-economics" className="ms-2 text-sm font-medium text-gray-900 dark:text-gray-300">Education &amp; Economics</label>
                                                                </li>
                                                                <li className="flex items-center mb-4">
                                                                    ...
                                                                    <label htmlhtmlFor="education-mathematics" className="ms-2 text-sm font-medium text-gray-900 dark:text-gray-300">Education &amp; Mathematics</label>
                                                                </li>
                                                                <li className="flex items-center mb-4">
                                                                    <input id="education-physics" type="checkbox" checked={checkboxValues.educationPhysics} onChange={handleCheckboxChange} className="w-4 h-4 text-blue-600 bg-gray-100 border-gray-300 rounded focus:ring-blue-500 dark:focus:ring-blue-600 dark:ring-offset-gray-800 focus:ring-2 dark:bg-gray-700 dark:border-gray-600" onClick={(e) => e.stopPropagation()} />
                                                                    <label htmlhtmlFor="education-physics" className="ms-2 text-sm font-medium text-gray-900 dark:text-gray-300">Education &amp; Physics</label>
                                                                </li>
                                                                <li className="flex items-center mb-4">
                                                                    ...
                                                                    <label htmlhtmlFor="education-religious-studies" className="ms-2 text-sm font-medium text-gray-900 dark:text-gray-300">Education &amp; Religious Studies</label>
                                                                </li>
                                                                <li className="flex items-center mb-4">
                                                                    ...
                                                                    <label htmlhtmlFor="education-social-science" className="ms-2 text-sm font-medium text-gray-900 dark:text-gray-300">Education &amp; Social Science</label>
                                                                </li>
                                                                <li className="flex items-center mb-4">
                                                                    ...
                                                                    <label htmlhtmlFor="education-biology" className="ms-2 text-sm font-medium text-gray-900 dark:text-gray-300">Education And Biology</label>
                                                                </li>
                                                                <li className="flex items-center mb-4">
                                                                    ...
                                                                    <label htmlhtmlFor="education-chemistry" className="ms-2 text-sm font-medium text-gray-900 dark:text-gray-300">Education And Chemistry</label>
                                                                </li>
                                                                <li className="flex items-center mb-4">
                                                                    <input id="education-english" type="checkbox" checked={checkboxValues.educationEnglish} onChange={handleCheckboxChange} className="w-4 h-4 text-blue-600 bg-gray-100 border-gray-300 rounded focus:ring-blue-500 dark:focus:ring-blue-600 dark:ring-offset-gray-800 focus:ring-2 dark:bg-gray-700 dark:border-gray-600" onClick={(e) => e.stopPropagation()} />
                                                                    <label htmlhtmlFor="education-english" className="ms-2 text-sm font-medium text-gray-900 dark:text-gray-300">Education And English Language</label>
                                                                </li>
                                                                <li className="flex items-center mb-4">
                                                                    ...
                                                                    <label htmlhtmlFor="education-french" className="ms-2 text-sm font-medium text-gray-900 dark:text-gray-300">Education And French</label>
                                                                </li>
                                                                <li className="flex items-center mb-4">
                                                                    ...
                                                                    <label htmlhtmlFor="education-geography-physics" className="ms-2 text-sm font-medium text-gray-900 dark:text-gray-300">Education And Geography/Physics</label>
                                                                </li>
                                                                <li className="flex items-center mb-4">
                                                                    ...
                                                                    <label htmlhtmlFor="education-political-science" className="ms-2 text-sm font-medium text-gray-900 dark:text-gray-300">Education And Political Science</label>
                                                                </li>
                                                                <li className="flex items-center mb-4">
                                                                    ...
                                                                    <label htmlhtmlFor="educational-foundations" className="ms-2 text-sm font-medium text-gray-900 dark:text-gray-300">Educational Foundations</label>
                                                                </li>
                                                                <li className="flex items-center mb-4">
                                                                    ...
                                                                    <label htmlhtmlFor="educational-psychology" className="ms-2 text-sm font-medium text-gray-900 dark:text-gray-300">Educational / Psychology Guidance And Counselling</label>
                                                                </li>
                                                                <li className="flex items-center mb-4">
                                                                    ...
                                                                    <label htmlhtmlFor="health-physical-education" className="ms-2 text-sm font-medium text-gray-900 dark:text-gray-300">Health and Physical Education</label>
                                                                </li>
                                                                <li className="flex items-center mb-4">
                                                                    <input id="library-information-science" type="checkbox" checked={checkboxValues.libraryInformationScience} onChange={handleCheckboxChange} className="w-4 h-4 text-blue-600 bg-gray-100 border-gray-300 rounded focus:ring-blue-500 dark:focus:ring-blue-600 dark:ring-offset-gray-800 focus:ring-2 dark:bg-gray-700 dark:border-gray-600" onClick={(e) => e.stopPropagation()} />
                                                                    <label htmlhtmlFor="library-information-science" className="ms-2 text-sm font-medium text-gray-900 dark:text-gray-300">Library and Information Science</label>
                                                                </li>
                                                                <li className="flex items-center mb-4">
                                                                    ...
                                                                    <label htmlhtmlFor="science-education" className="ms-2 text-sm font-medium text-gray-900 dark:text-gray-300">Science Education</label>
                                                                </li>
                                                                <li className="flex items-center mb-4">
                                                                    ...
                                                                    <label htmlhtmlFor="social-sciences-education" className="ms-2 text-sm font-medium text-gray-900 dark:text-gray-300">Social Sciences Education</label>
                                                                </li>
                                                                <li className="flex items-center mb-4">
                                                                    ...
                                                                    <label htmlhtmlFor="vocational-teacher-education" className="ms-2 text-sm font-medium text-gray-900 dark:text-gray-300">Vocational Teacher Education (Technical Education)</label>
                                                                </li>
                                                                <li className="flex items-center mb-4">
                                                                    ...
                                                                    <label htmlhtmlFor="religion" className="ms-2 text-sm font-medium text-gray-900 dark:text-gray-300">Religion</label>
                                                                </li>
                                                                <li className="flex items-center mb-4">
                                                                    <input id="igbo-linguistics" type="checkbox" checked={checkboxValues.igboLinguistics} onChange={handleCheckboxChange} className="w-4 h-4 text-blue-600 bg-gray-100 border-gray-300 rounded focus:ring-blue-500 dark:focus:ring-blue-600 dark:ring-offset-gray-800 focus:ring-2 dark:bg-gray-700 dark:border-gray-600" onClick={(e) => e.stopPropagation()} />
                                                                    <label htmlhtmlFor="igbo-linguistics" className="ms-2 text-sm font-medium text-gray-900 dark:text-gray-300">Igbo Linguistics</label>
                                                                </li>
                                                            </ul>
                                                        </div>
                                                    )}
                                                ...
                                                <li className="flex flex-col mb-4" onClick={() => eachCategoryDropDown('engineering')}>
                                                    <div className="flex items-center hover:bg-gray-100 dark:hover:bg-gray-700">
                                                        ...
                                                        <label htmlhtmlFor="engineering-checkbox" className="ms-2 text-sm font-medium text-gray-900 dark:text-gray-300">Engineering</label>
                                                        ...
                                                        <div className="ms-3">
                                                            <ul>
                                                                <li className="flex items-center mb-4">
                                                                    ...
                                                                    <label htmlhtmlFor="agricultural-bioresources-engineering" className="ms-2 text-sm font-medium text-gray-900 dark:text-gray-300">Agricultural and Bioresources Engineering</label>
                                                                </li>
                                                                <li className="flex items-center mb-4">
                                                                    ...
                                                                    <label htmlhtmlFor="civil-engineering" className="ms-2 text-sm font-medium text-gray-900 dark:text-gray-300">Civil Engineering</label>
                                                                </li>
                                                                <li className="flex items-center mb-4">
                                                                    ...
                                                                    <label htmlhtmlFor="chemical-engineering" className="ms-2 text-sm font-medium text-gray-900 dark:text-gray-300">Chemical Engineering</label>
                                                                </li>
                                                                <li className="flex items-center mb-4">
                                                                    ...
                                                                    <label htmlhtmlFor="computer-engineering" className="ms-2 text-sm font-medium text-gray-900 dark:text-gray-300">Computer Engineering</label>
                                                                </li>
                                                                <li className="flex items-center mb-4">
                                                                    ...
                                                                    <label htmlhtmlFor="electrical-engineering" className="ms-2 text-sm font-medium text-gray-900 dark:text-gray-300">Electrical Engineering</label>
                                                                </li>
                                                                <li className="flex items-center mb-4">
                                                                    ...
                                                                    <label htmlhtmlFor="electronic-engineering" className="ms-2 text-sm font-medium text-gray-900 dark:text-gray-300">Electronic Engineering</label>
                                                                </li>
                                                                <li className="flex items-center mb-4">
                                                                    ...
                                                                    <label htmlhtmlFor="marine-engineering" className="ms-2 text-sm font-medium text-gray-900 dark:text-gray-300">Marine Engineering</label>
                                                                </li>
                                                                <li className="flex items-center mb-4">
                                                                    ...
                                                                    <label htmlhtmlFor="mechanical-engineering" className="ms-2 text-sm font-medium text-gray-900 dark:text-gray-300">Mechanical Engineering</label>
                                                                </li>
                                                                <li className="flex items-center mb-4">
                                                                    ...
                                                                    <label htmlhtmlFor="metallurgical-materials-engineering" className="ms-2 text-sm font-medium text-gray-900 dark:text-gray-300">Metallurgical and Materials Engineering</label>
                                                                </li>
                                                                <li className="flex items-center mb-4">
                                                                    ...
                                                                    <label htmlhtmlFor="petroleum-gas-engineering" className="ms-2 text-sm font-medium text-gray-900 dark:text-gray-300">Petroleum and Gas Engineering</label>
                                                                </li>
                                                                <li className="flex items-center mb-4">
                                                                    <input id="systems-engineering" type="checkbox" checked={checkboxValues.systemsEngineering} onChange={handleCheckboxChange} className="w-4 h-4 text-blue-600 bg-gray-100 border-gray-300 rounded focus:ring-blue-500 dark:focus:ring-blue-600 dark:ring-offset-gray-800 focus:ring-2 dark:bg-gray-700 dark:border-gray-600" onClick={(e) => e.stopPropagation()} />
                                                                    <label htmlhtmlFor="systems-engineering" className="ms-2 text-sm font-medium text-gray-900 dark:text-gray-300">Systems Engineering</label>
                                                                </li>
                                                                <li className="flex items-center mb-4">
                                                                    ...
                                                                    <label htmlhtmlFor="structural-engineering" className="ms-2 text-sm font-medium text-gray-900 dark:text-gray-300">Structural Engineering</label>
                                                                </li>
                                                                <li className="flex items-center mb-4">
                                                                    <input id="production-industrial-engineering" type="checkbox" checked={checkboxValues.productionEngineering} onChange={handleCheckboxChange} className="w-4 h-4 text-blue-600 bg-gray-100 border-gray-300 rounded focus:ring-blue-500 dark:focus:ring-blue-600 dark:ring-offset-gray-800 focus:ring-2 dark:bg-gray-700 dark:border-gray-600" onClick={(e) => e.stopPropagation()} />
                                                                    <label htmlhtmlFor="production-industrial-engineering" className="ms-2 text-sm font-medium text-gray-900 dark:text-gray-300">Production and Industrial Engineering</label>
                                                                </li>
                                                            </ul>
                                                        </div>
                                                    )}
                                                ...
                                                <li className="flex flex-col mb-4" onClick={() => eachCategoryDropDown('environmentalSciences')}>
                                                    <div className="flex items-center hover:bg-gray-100 dark:hover:bg-gray-700">
                                                        ...
                                                        <label htmlhtmlFor="environmental-sciences-checkbox" className="ms-2 text-sm font-medium text-gray-900 dark:text-gray-300">Environmental Sciences</label>
                                                        ...
                                                        <div className="ms-3">
                                                            <ul>
                                                                <li className="flex items-center mb-4">
                                                                    ...
                                                                    <label htmlhtmlFor="architecture" className="ms-2 text-sm font-medium text-gray-900 dark:text-gray-300">Architecture</label>
                                                                </li>
                                                                <li className="flex items-center mb-4">
                                                                    ...
                                                                    <label htmlhtmlFor="estate-management" className="ms-2 text-sm font-medium text-gray-900 dark:text-gray-300">Estate Management</label>
                                                                </li>
                                                                <li className="flex items-center mb-4">
                                                                    ...
                                                                    <label htmlhtmlFor="quantity-surveying" className="ms-2 text-sm font-medium text-gray-900 dark:text-gray-300">Quantity Surveying</label>
                                                                </li>
                                                                <li className="flex items-center mb-4">
                                                                    ...
                                                                    <label htmlhtmlFor="building" className="ms-2 text-sm font-medium text-gray-900 dark:text-gray-300">Building</label>
                                                                </li>
                                                                <li className="flex items-center mb-4">
                                                                    ...
                                                                    <label htmlhtmlFor="geoinformatics-surveying" className="ms-2 text-sm font-medium text-gray-900 dark:text-gray-300">Geoinformatics and Surveying</label>
                                                                </li>
                                                                <li className="flex items-center mb-4">
                                                                    ...
                                                                    <label htmlhtmlFor="urban-regional-planning" className="ms-2 text-sm font-medium text-gray-900 dark:text-gray-300">Urban and Regional Planning</label>
                                                                </li>
                                                            </ul>
                                                        </div>
                                                    )}
                                                ...
                                                <li className="flex flex-col mb-4" onClick={() => eachCategoryDropDown('healthSciencesTechnology')}>
                                                    <div className="flex items-center hover:bg-gray-100 dark:hover:bg-gray-700">
                                                        ...
                                                        <label htmlhtmlFor="health-sciences-technology-checkbox" className="ms-2 text-sm font-medium text-gray-900 dark:text-gray-300">Health Sciences &amp; Technology</label>
                                                        ...
                                                        <div className="ms-3">
                                                            <ul>
                                                                <li className="flex items-center mb-4">
                                                                    ...
                                                                    <label htmlhtmlFor="health-administration-management" className="ms-2 text-sm font-medium text-gray-900 dark:text-gray-300">Health Administration and Management</label>
                                                                </li>
                                                                <li className="flex items-center mb-4">
                                                                    ...
                                                                    <label htmlhtmlFor="medical-laboratory-sciences" className="ms-2 text-sm font-medium text-gray-900 dark:text-gray-300">Medical Laboratory Sciences</label>
                                                                </li>
                                                                <li className="flex items-center mb-4">
                                                                    ...
                                                                    <label htmlhtmlFor="medical-radiography-radiological-sciences" className="ms-2 text-sm font-medium text-gray-900 dark:text-gray-300">Medical Radiography and Radiological Sciences</label>
                                                                </li>
                                                                <li className="flex items-center mb-4">
                                                                    ...
                                                                    <label htmlhtmlFor="medical-rehabilitation" className="ms-2 text-sm font-medium text-gray-900 dark:text-gray-300">Medical Rehabilitation</label>
                                                                </li>
                                                                <li className="flex items-center mb-4">
                                                                    ...
                                                                    <label htmlhtmlFor="nursing-sciences" className="ms-2 text-sm font-medium text-gray-900 dark:text-gray-300">Nursing Sciences</label>
                                                                </li>
                                                            </ul>
                                                        </div>
                                                    )}
                                                ...
                                                <li className="flex flex-col mb-4" onClick={() => eachCategoryDropDown('law')}>
                                                    <div className="flex items-center hover:bg-gray-100 dark:hover:bg-gray-700">
                                                        ...
                                                        <label htmlhtmlFor="law-checkbox" className="ms-2 text-sm font-medium text-gray-900 dark:text-gray-300">Law</label>
                                                        ...
                                                        <div className="ms-3">
                                                            <ul>
                                                                <li className="flex items-center mb-4">
                                                                    ...
                                                                    <label htmlhtmlFor="commercial-property-law" className="ms-2 text-sm font-medium text-gray-900 dark:text-gray-300">Commercial and Property Law</label>
                                                                </li>
                                                                <li className="flex items-center mb-4">
                                                                    ...
                                                                    <label htmlhtmlFor="international-jurisprudence" className="ms-2 text-sm font-medium text-gray-900 dark:text-gray-300">International and Jurisprudence</label>
                                                                </li>
                                                                <li className="flex items-center mb-4">
                                                                    ...
                                                                    <label htmlhtmlFor="private-public-law" className="ms-2 text-sm font-medium text-gray-900 dark:text-gray-300">Private and Public Law</label>
                                                                </li>
                                                            </ul>
                                                        </div>
                                                    )}
                                                ...
                                                <li className="flex flex-col mb-4" onClick={() => eachCategoryDropDown('medicalSciences')}>
                                                    <div className="flex items-center hover:bg-gray-100 dark:hover:bg-gray-700">
                                                        ...
                                                        <label htmlhtmlFor="medicalSciences-checkbox" className="ms-2 text-sm font-medium text-gray-900 dark:text-gray-300">Medical Sciences</label>
                                                        ...
                                                        <div className="ms-3">
                                                            <ul>
                                                                <li className="flex items-center mb-4">
                                                                    ...
                                                                    <label htmlhtmlFor="anatomy" className="ms-2 text-sm font-medium text-gray-900 dark:text-gray-300">Anatomy</label>
                                                                </li>
                                                                <li className="flex items-center mb-4">
                                                                    ...
                                                                    <label htmlhtmlFor="anesthesia" className="ms-2 text-sm font-medium text-gray-900 dark:text-gray-300">Anesthesia</label>
                                                                </li>
                                                                <li className="flex items-center mb-4">
                                                                    ...
                                                                    <label htmlhtmlFor="chemicalPathology" className="ms-2 text-sm font-medium text-gray-900 dark:text-gray-300">Chemical Pathology</label>
                                                                </li>
                                                                <li className="flex items-center mb-4">
                                                                    ...
                                                                    <label htmlhtmlFor="communityMedicine" className="ms-2 text-sm font-medium text-gray-900 dark:text-gray-300">Community Medicine</label>
                                                                </li>
                                                                <li className="flex items-center mb-4">
                                                                    ...
                                                                    <label htmlhtmlFor="dermatology" className="ms-2 text-sm font-medium text-gray-900 dark:text-gray-300">Dermatology</label>
                                                                </li>
                                                                <li className="flex items-center mb-4">
                                                                    ...
                                                                    <label htmlhtmlFor="hematologyAndImmunology" className="ms-2 text-sm font-medium text-gray-900 dark:text-gray-300">Hematology and Immunology</label>
                                                                </li>
                                                                <li className="flex items-center mb-4">
                                                                    ...
                                                                    <label htmlhtmlFor="medicalBiochemistry" className="ms-2 text-sm font-medium text-gray-900 dark:text-gray-300">Medical Biochemistry</label>
                                                                </li>
                                                                <li className="flex items-center mb-4">
                                                                    ...
                                                                    <label htmlhtmlFor="medicalMicrobiology" className="ms-2 text-sm font-medium text-gray-900 dark:text-gray-300">Medical Microbiology</label>
                                                                </li>
                                                                <li className="flex items-center mb-4">
                                                                    ...
                                                                    <label htmlhtmlFor="medicine" className="ms-2 text-sm font-medium text-gray-900 dark:text-gray-300">Medicine</label>
                                                                </li>
                                                                <li className="flex items-center mb-4">
                                                                    ...
                                                                    <label htmlhtmlFor="morbidAnatomy" className="ms-2 text-sm font-medium text-gray-900 dark:text-gray-300">Morbid Anatomy</label>
                                                                </li>
                                                                <li className="flex items-center mb-4">
                                                                    ...
                                                                    <label htmlhtmlFor="obstetricsAndGynecology" className="ms-2 text-sm font-medium text-gray-900 dark:text-gray-300">Obstetrics and Gynecology</label>
                                                                </li>
                                                                <li className="flex items-center mb-4">
                                                                    ...
                                                                    <label htmlhtmlFor="ophthalmology" className="ms-2 text-sm font-medium text-gray-900 dark:text-gray-300">Ophthalmology</label>
                                                                </li>
                                                                <li className="flex items-center mb-4">
                                                                    ...
                                                                    <label htmlhtmlFor="otolaryngology" className="ms-2 text-sm font-medium text-gray-900 dark:text-gray-300">Otolaryngology</label>
                                                                </li>
                                                                <li className="flex items-center mb-4">
                                                                    ...
                                                                    <label htmlhtmlFor="pediatrics" className="ms-2 text-sm font-medium text-gray-900 dark:text-gray-300">Pediatrics</label>
                                                                </li>
                                                                <li className="flex items-center mb-4">
                                                                    <input id="pharmacologyAndTherapeutics" type="checkbox" checked={checkboxValues.pharmacology} onChange={handleCheckboxChange} className="w-4 h-4 text-blue-600 bg-gray-100 border-gray-300 rounded focus:ring-blue-500 dark:focus:ring-blue-600 dark:ring-offset-gray-800 focus:ring-2 dark:bg-gray-700 dark:border-gray-600" onClick={(e) => e.stopPropagation()} />
                                                                    <label htmlhtmlFor="pharmacologyAndTherapeutics" className="ms-2 text-sm font-medium text-gray-900 dark:text-gray-300">Pharmacology and Therapeutics</label>
                                                                </li>
                                                                <li className="flex items-center mb-4">
                                                                    ...
                                                                    <label htmlhtmlFor="physiology" className="ms-2 text-sm font-medium text-gray-900 dark:text-gray-300">Physiology</label>
                                                                </li>
                                                                <li className="flex items-center mb-4">
                                                                    <input id="radiationMedicine" type="checkbox" checked={checkboxValues.radiationMedicine} onChange={handleCheckboxChange} className="w-4 h-4 text-blue-600 bg-gray-100 border-gray-300 rounded focus:ring-blue-500 dark:focus:ring-blue-600 dark:ring-offset-gray-800 focus:ring-2 dark:bg-gray-700 dark:border-gray-600" onClick={(e) => e.stopPropagation()} />
                                                                    <label htmlhtmlFor="radiationMedicine" className="ms-2 text-sm font-medium text-gray-900 dark:text-gray-300">Radiation Medicine</label>
                                                                </li>
                                                                <li className="flex items-center mb-4">
                                                                    <input id="surgery" type="checkbox" checked={checkboxValues.surgery} onChange={handleCheckboxChange} className="w-4 h-4 text-blue-600 bg-gray-100 border-gray-300 rounded focus:ring-blue-500 dark:focus:ring-blue-600 dark:ring-offset-gray-800 focus:ring-2 dark:bg-gray-700 dark:border-gray-600" onClick={(e) => e.stopPropagation()} />
                                                                    <label htmlhtmlFor="surgery" className="ms-2 text-sm font-medium text-gray-900 dark:text-gray-300">Surgery</label>
                                                                </li>
                                                                <li className="flex items-center mb-4">
                                                                    <input id="psychologicalMedicine" type="checkbox" checked={checkboxValues.psychologicalMedicine} onChange={handleCheckboxChange} className="w-4 h-4 text-blue-600 bg-gray-100 border-gray-300 rounded focus:ring-blue-500 dark:focus:ring-blue-600 dark:ring-offset-gray-800 focus:ring-2 dark:bg-gray-700 dark:border-gray-600" onClick={(e) => e.stopPropagation()} />
                                                                    <label htmlhtmlFor="psychologicalMedicine" className="ms-2 text-sm font-medium text-gray-900 dark:text-gray-300">Psychological Medicine</label>
                                                                </li>
                                                                <li className="flex items-center mb-4">
                                                                    ...
                                                                    <label htmlhtmlFor="childDentalHealth" className="ms-2 text-sm font-medium text-gray-900 dark:text-gray-300">Child Dental Health</label>
                                                                </li>
                                                            </ul>
                                                        </div>
                                                    )}
                                                ...
                                                <li className="flex flex-col mb-4" onClick={() => eachCategoryDropDown('pharmaceuticalSciences')}>
                                                    <div className="flex items-center hover:bg-gray-100 dark:hover:bg-gray-700">
                                                        ...
                                                        <label htmlhtmlFor="pharmaceuticalSciences-checkbox" className="ms-2 text-sm font-medium text-gray-900 dark:text-gray-300">Pharmaceutical Sciences</label>
                                                        ...
                                                        <div className="ms-3">
                                                            <ul>
                                                                <li className="flex items-center mb-4">
                                                                    ...
                                                                    <label htmlhtmlFor="clinicalPharmacyAndPharmacyManagement" className="ms-2 text-sm font-medium text-gray-900 dark:text-gray-300">Clinical Pharmacy and Pharmacy Management</label>
                                                                </li>
                                                                <li className="flex items-center mb-4">
                                                                    ...
                                                                    <label htmlhtmlFor="pharmaceuticalChemistryAndIndustrialPharmacy" className="ms-2 text-sm font-medium text-gray-900 dark:text-gray-300">Pharmaceutical Chemistry and Industrial Pharmacy</label>
                                                                </li>
                                                                <li className="flex items-center mb-4">
                                                                    ...
                                                                    <label htmlhtmlFor="pharmaceuticalTechnologyAndIndustrialPharmacy" className="ms-2 text-sm font-medium text-gray-900 dark:text-gray-300">Pharmaceutical Technology and Industrial Pharmacy</label>
                                                                </li>
                                                                <li className="flex items-center mb-4">
                                                                    ...
                                                                    <label htmlhtmlFor="pharmaceutics" className="ms-2 text-sm font-medium text-gray-900 dark:text-gray-300">Pharmaceutics</label>
                                                                </li>
                                                                <li className="flex items-center mb-4">
                                                                    ...
                                                                    <label htmlhtmlFor="pharmacognosy" className="ms-2 text-sm font-medium text-gray-900 dark:text-gray-300">Pharmacognosy</label>
                                                                </li>
                                                                <li className="flex items-center mb-4">
                                                                    ...
                                                                    <label htmlhtmlFor="departmentOfPharmacologyAndToxicology" className="ms-2 text-sm font-medium text-gray-900 dark:text-gray-300">Department of Pharmacology and Toxicology</label>
                                                                </li>
                                                            </ul>
                                                        </div>
                                                    )}
                                                ...
                                                <li className="flex flex-col mb-4" onClick={() => eachCategoryDropDown('physicalSciences')}>
                                                    <div className="flex items-center hover:bg-gray-100 dark:hover:bg-gray-700">
                                                        ...
                                                        <label htmlhtmlFor="physicalSciences-checkbox" className="ms-2 text-sm font-medium text-gray-900 dark:text-gray-300">Physical Sciences</label>
                                                        ...
                                                        <div className="ms-3">
                                                            <ul>
                                                                <li className="flex items-center mb-4">
                                                                    ...
                                                                    <label htmlhtmlFor="computerScience" className="ms-2 text-sm font-medium text-gray-900 dark:text-gray-300">Computer Science</label>
                                                                </li>
                                                                <li className="flex items-center mb-4">
                                                                    ...
                                                                    <label htmlhtmlFor="geology" className="ms-2 text-sm font-medium text-gray-900 dark:text-gray-300">Geology</label>
                                                                </li>
                                                                <li className="flex items-center mb-4">
                                                                    ...
                                                                    <label htmlhtmlFor="mathematics" className="ms-2 text-sm font-medium text-gray-900 dark:text-gray-300">Mathematics</label>
                                                                </li>
                                                                <li className="flex items-center mb-4">
                                                                    ...
                                                                    <label htmlhtmlFor="physicsAndAstronomy" className="ms-2 text-sm font-medium text-gray-900 dark:text-gray-300">Physics and Astronomy</label>
                                                                </li>
                                                                <li className="flex items-center mb-4">
                                                                    ...
                                                                    <label htmlhtmlFor="geophysics" className="ms-2 text-sm font-medium text-gray-900 dark:text-gray-300">Geophysics</label>
                                                                </li>
                                                                <li className="flex items-center mb-4">
                                                                    <input id="pureAndIndustrialChemistry" type="checkbox" checked={checkboxValues.industrialChemistry} onChange={handleCheckboxChange} className="w-4 h-4 text-blue-600 bg-gray-100 border-gray-300 rounded focus:ring-blue-500 dark:focus:ring-blue-600 dark:ring-offset-gray-800 focus:ring-2 dark:bg-gray-700 dark:border-gray-600" onClick={(e) => e.stopPropagation()} />
                                                                    <label htmlhtmlFor="pureAndIndustrialChemistry" className="ms-2 text-sm font-medium text-gray-900 dark:text-gray-300">Pure and Industrial Chemistry</label>
                                                                </li>
                                                                <li className="flex items-center mb-4">
                                                                    ...
                                                                    <label htmlhtmlFor="statistics" className="ms-2 text-sm font-medium text-gray-900 dark:text-gray-300">Statistics</label>
                                                                </li>
                                                            </ul>
                                                        </div>
                                                    )}
                                                ...
                                                <li className="flex flex-col mb-4" onClick={() => eachCategoryDropDown('socialSciences')}>
                                                    <div className="flex items-center hover:bg-gray-100 dark:hover:bg-gray-700">
                                                        ...
                                                        <label htmlhtmlFor="socialSciences-checkbox" className="ms-2 text-sm font-medium text-gray-900 dark:text-gray-300">Social Sciences</label>
                                                        ...
                                                        <div className="ms-3">
                                                            <ul>
                                                                <li className="flex items-center mb-4">
                                                                    ...
                                                                    <label htmlhtmlFor="economics" className="ms-2 text-sm font-medium text-gray-900 dark:text-gray-300">Economics</label>
                                                                </li>
                                                                <li className="flex items-center mb-4">
                                                                    <input id="geography" type="checkbox" checked={checkboxValues.geography} onChange={handleCheckboxChange} className="w-4 h-4 text-blue-600 bg-gray-100 border-gray-300 rounded focus:ring-blue-500 dark:focus:ring-blue-600 dark:ring-offset-gray-800 focus:ring-2 dark:bg-gray-700 dark:border-gray-600" onClick={(e) => e.stopPropagation()} />
                                                                    <label htmlhtmlFor="geography" className="ms-2 text-sm font-medium text-gray-900 dark:text-gray-300">Geography</label>
                                                                </li>
                                                                <li className="flex items-center mb-4">
                                                                    <input id="philosophy" type="checkbox" checked={checkboxValues.philosophy} onChange={handleCheckboxChange} className="w-4 h-4 text-blue-600 bg-gray-100 border-gray-300 rounded focus:ring-blue-500 dark:focus:ring-blue-600 dark:ring-offset-gray-800 focus:ring-2 dark:bg-gray-700 dark:border-gray-600" onClick={(e) => e.stopPropagation()} />
                                                                    <label htmlhtmlFor="philosophy" className="ms-2 text-sm font-medium text-gray-900 dark:text-gray-300">Philosophy</label>
                                                                </li>
                                                                <li className="flex items-center mb-4">
                                                                    ...
                                                                    <label htmlhtmlFor="politicalScience" className="ms-2 text-sm font-medium text-gray-900 dark:text-gray-300">Political Science</label>
                                                                </li>
                                                                <li className="flex items-center mb-4">
                                                                    <input id="psychology" type="checkbox" checked={checkboxValues.psychology} onChange={handleCheckboxChange} className="w-4 h-4 text-blue-600 bg-gray-100 border-gray-300 rounded focus:ring-blue-500 dark:focus:ring-blue-600 dark:ring-offset-gray-800 focus:ring-2 dark:bg-gray-700 dark:border-gray-600" onClick={(e) => e.stopPropagation()} />
                                                                    <label htmlhtmlFor="psychology" className="ms-2 text-sm font-medium text-gray-900 dark:text-gray-300">Psychology</label>
                                                                </li>
                                                                <li className="flex items-center mb-4">
                                                                    <input id="publicAdministration" type="checkbox" checked={checkboxValues.publicAdministration} onChange={handleCheckboxChange} className="w-4 h-4 text-blue-600 bg-gray-100 border-gray-300 rounded focus:ring-blue-500 dark:focus:ring-blue-600 dark:ring-offset-gray-800 focus:ring-2 dark:bg-gray-700 dark:border-gray-600" onClick={(e) => e.stopPropagation()} />
                                                                    <label htmlhtmlFor="publicAdministration" className="ms-2 text-sm font-medium text-gray-900 dark:text-gray-300">Public Administration and Local Government</label>
                                                                </li>
                                                                <li className="flex items-center mb-4">
                                                                    <input id="religion" type="checkbox" checked={checkboxValues.religion} onChange={handleCheckboxChange} className="w-4 h-4 text-blue-600 bg-gray-100 border-gray-300 rounded focus:ring-blue-500 dark:focus:ring-blue-600 dark:ring-offset-gray-800 focus:ring-2 dark:bg-gray-700 dark:border-gray-600" onClick={(e) => e.stopPropagation()} />
                                                                    <label htmlhtmlFor="religion" className="ms-2 text-sm font-medium text-gray-900 dark:text-gray-300">Religion</label>
                                                                ...
                                                                <li className="flex items-center mb-4">
                                                                    ...
                                                                    <label htmlhtmlFor="socialWork" className="ms-2 text-sm font-medium text-gray-900 dark:text-gray-300">Social Work</label>
                                                                </li>
                                                                <li className="flex items-center mb-4">
                                                                    ...
                                                                    <label htmlhtmlFor="sociologyAnthropology" className="ms-2 text-sm font-medium text-gray-900 dark:text-gray-300">Sociology/Anthropology</label>
                                                                </li>
                                                            </ul>
                                                        </div>
                                                    )}
                                                ...
                                                <li className="flex flex-col mb-4" onClick={() => eachCategoryDropDown('veterinaryMedicine')}>
                                                    <div className="flex items-center hover:bg-gray-100 dark:hover:bg-gray-700">
                                                        ...
                                                        <label htmlhtmlFor="veterinaryMedicine-checkbox" className="ms-2 text-sm font-medium text-gray-900 dark:text-gray-300">Veterinary Medicine</label>
                                                        ...
                                                        <div className="ms-3">
                                                            <ul>
                                                                <li className="flex items-center mb-4">
                                                                    ...
                                                                    <label htmlhtmlFor="veterinaryPhysiologyPharmacology" className="ms-2 text-sm font-medium text-gray-900 dark:text-gray-300">Veterinary Physiology/Pharmacology</label>
                                                                </li>
                                                                <li className="flex items-center mb-4">
                                                                    ...
                                                                    <label htmlhtmlFor="veterinaryAnatomy" className="ms-2 text-sm font-medium text-gray-900 dark:text-gray-300">Veterinary Anatomy</label>
                                                                </li>
                                                                <li className="flex items-center mb-4">
                                                                    ...
                                                                    <label htmlhtmlFor="animalHealthProduction" className="ms-2 text-sm font-medium text-gray-900 dark:text-gray-300">Animal Health and Production</label>
                                                                </li>
                                                                <li className="flex items-center mb-4">
                                                                    ...
                                                                    <label htmlhtmlFor="veterinaryParasitologyEntomology" className="ms-2 text-sm font-medium text-gray-900 dark:text-gray-300">Veterinary Parasitology and Entomology</label>
                                                                </li>
                                                                <li className="flex items-center mb-4">
                                                                    ...
                                                                    <label htmlhtmlFor="veterinaryPathologyMicrobiology" className="ms-2 text-sm font-medium text-gray-900 dark:text-gray-300">Veterinary Pathology and Microbiology</label>
                                                                </li>
                                                                <li className="flex items-center mb-4">
                                                                    ...
                                                                    <label htmlhtmlFor="veterinaryPublicHealth" className="ms-2 text-sm font-medium text-gray-900 dark:text-gray-300">Veterinary Public Health and Preventive Medicine</label>
                                                                </li>
                                                                <li className="flex items-center mb-4">
                                                                    ...
                                                                    <label htmlhtmlFor="veterinarySurgery" className="ms-2 text-sm font-medium text-gray-900 dark:text-gray-300">Veterinary Surgery</label>
                                                                </li>
                                                                <li className="flex items-center mb-4">
                                                                    <input id="veterinaryMedicine" type="checkbox" checked={checkboxValues.veterinaryMedicine} onChange={handleCheckboxChange} className="w-4 h-4 text-blue-600 bg-gray-100 border-gray-300 rounded focus:ring-blue-500 dark:focus:ring-blue-600 dark:ring-offset-gray-800 focus:ring-2 dark:bg-gray-700 dark:border-gray-600" onClick={(e) => e.stopPropagation()} />
                                                                    <label htmlhtmlFor="veterinaryMedicine" className="ms-2 text-sm font-medium text-gray-900 dark:text-gray-300">Veterinary Medicine</label>
                                                                </li>
                                                                <li className="flex items-center mb-4">
                                                                    ...
                                                                    <label htmlhtmlFor="veterinaryObstetricsReproductiveDiseases" className="ms-2 text-sm font-medium text-gray-900 dark:text-gray-300">Veterinary Obstetrics and Reproductive Diseases</label>
                                                                </li>
                                                                <li className="flex items-center mb-4">
                                                                    ...
                                                                    <label htmlhtmlFor="veterinaryTeachingHospital" className="ms-2 text-sm font-medium text-gray-900 dark:text-gray-300">Veterinary Teaching Hospital</label>
                                                                </li>
                                                            </ul>
                                                        </div>
                                                    )}
