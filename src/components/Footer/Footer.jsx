            ...
            <footer className="bg-gray-200 lg:grid lg:grid-cols-5">
                <div className="relative block h-32 lg:col-span-1 lg:h-56">
                    <img
                        src={logo}
                        alt=""
                        className="absolute inset-0 top-5 h-full w-auto object-cover"
                    />
                </div>
                ...
                <div className="px-4 py-16 sm:px-6 lg:col-span-4 lg:px-8">
                    <div className="grid grid-cols-1 gap-8 sm:grid-cols-2">
                        <div>
                            <p>
                                <span className="text-md  tracking-wide text-gray-500"> No 1 destination for rich African research and intellectual material partnering with global institutions</span>
                            ...
                            <ul className="mt-8 flex gap-6">
                                ...
                                <li>
                                    <a href="https://x.com/iwemiresearch?t=diZXhep8JomhLZxctn6lIA&s=08"
                                        className="text-gray-500 hover:text-gray-900 dark:hover:text-white"
                                        target="_blank"
                                        rel="noopener noreferrer">
                        ...
                        <div className="grid grid-cols-1 gap-4 sm:grid-cols-2">
                            <div>
                                ...
                                <ul className="mt-6 space-y-4 text-sm">
                                    <li>
                                        <a href="/about" className="text-gray-700 text-lg duration-300 font-semibold transition-all hover:opacity-75"> About </a>
                                    </li>

                                    <li>
                                        <a href="/terms-Conditions" className="text-gray-700 text-lg duration-300 font-semibold transition-all hover:opacity-75"> Terms & Conditions </a>
                                    </li>
                            ...
                            <ul className="mt-6 space-y-4 text-sm">
                                    ...
                                    <li>
                                        <a href="/FAQs" className="text-gray-700 text-lg duration-300 font-semibold transition-all hover:opacity-75"> FAQs </a>
                                    </li>

                                    <li>
                                        <a href="/contact" className="text-gray-700 text-lg duration-300 font-semibold transition-all hover:opacity-75"> Contact </a>
                                    </li>

                                    <li>
                                        <a href="/privacy-Policy" className="text-gray-700 text-lg duration-300 font-semibold transition-all hover:opacity-75"> Privacy Policy </a>
                                    </li>
                                </ul>
                            </div>
